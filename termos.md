...
- Usar o aplicativo para fins comerciais sem autorização prévia
...
- Compartilhar dados de terceiros sem consentimento
- Tentar comprometer a segurança ou integridade do aplicativo

---

## 5. Conta e Responsabilidade

**5.1** Você é responsável por manter a confidencialidade do seu PIN e credenciais de acesso.
...
**9.3** Não garantimos que o aplicativo estará livre de erros ou disponível ininterruptamente.

---

## 10. Atualizações

**10.1** Podemos atualizar o aplicativo periodicamente para corrigir erros, adicionar funcionalidades ou melhorar a segurança.

**10.2** Recomendamos manter o aplicativo atualizado para garantir o melhor desempenho e segurança.

**10.3** Nos reservamos o direito de alterar estes Termos de Uso. Alterações relevantes serão comunicadas por notificação no aplicativo.
...
- Falhas de conectividade ou de serviços de terceiros
...
**12.2** Fica eleito o foro da comarca de São Paulo/SP para dirimir quaisquer controvérsias decorrentes destes Termos, com renúncia a qualquer outro, por mais privilegiado que seja.
...
**14.1** Se qualquer disposição destes Termos for considerada inválida, as demais disposições permanecerão em pleno vigor.
...
*Estes Termos de Uso foram elaborados em conformidade com o Código de Defesa do Consumidor (Lei nº 8.078/1990), a Lei Geral de Proteção de Dados (Lei nº 13.709/2018) e o Marco Civil da Internet (Lei nº 12.965/2014).*
